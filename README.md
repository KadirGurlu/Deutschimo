...
- 66 ünitenin tamamında seviye ve konuya özgü olumlu, olumsuz ve soru cümleleri kullanılır.
- A1 düzeyindeki 96 temel kelime ve ifade için kısa, günlük ve elle yazılmış örnek cümle bulunur.
- A1 örneklerinde uzun, soyut ve akademik cümleler kullanılmaz.
- A2 örnekleri günlük yaşam ve bağımsız iletişim durumlarına, B1-B2 örnekleri ise gerekçe, görüş, kanıt ve akademik/mesleki bağlama göre kademeli zorlaşır.
- `Der Ausdruck ...`, `Wir verwenden das Verb ...` gibi yapay ve tekrar eden şablonlar kaldırılmıştır.
- Her Almanca öğretim örneğinin görünür Türkçe karşılığı vardır.
