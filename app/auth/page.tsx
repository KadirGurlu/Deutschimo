...
function AuthContent() {
  ...
  return <div className="auth-shell"><section className="auth-visual"><span className="eyebrow" style={{color:"var(--turquoise)"}}>DEUTSCHIMO V12</span><h1>Öğrenme planın artık sana uyum sağlıyor.</h1><p>Güvenli hesabın, cihazlar arası ilerlemen ve kişiselleştirilmiş öğrenme zekân tek platformda.</p><ul className="check-list">{["A1–B2 seviye belirleme sınavı","Zayıf konu tespiti ve akıllı tekrar","Günlük kişiselleştirilmiş çalışma planı"].map((item) => <li key={item}><CheckCircle2 size={19}/>{item}</li>)}</ul></section>
