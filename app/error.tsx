...
export default function ErrorPage({
  ...
  return (
    <section className="standalone-form" aria-labelledby="page-error-title">
      <section className="form-card">
        <span className="eyebrow">HATA</span>
        <h1 id="page-error-title">Sayfa şu anda tamamlanamadı.</h1>
        <p>Tekrar deneyin. Sorun devam ederse hata kodunu destek ekibine iletin.</p>
        <div
