...
import { Award, BarChart3, BookOpen, BriefcaseBusiness, Check, CheckCircle2, GraduationCap, Headphones, Languages, MessageCircle, Mic2, PenLine, Play, School, SearchCheck, ShieldCheck, Sparkles, Target, Timer, TrendingUp, Users, Volume2 } from "lucide-react";
...
const levels = [
  ["A1", "Almancaya Başlangıç", "10 hafta", "12 ünite", "96 ders"],
  ["A2", "Temel İletişim", "12 hafta", "14 ünite", "110 ders"],
  ["B1", "Bağımsız Dil Kullanımı", "16 hafta", "16 ünite", "138 ders"],
  ["B2", "Akademik ve Profesyonel", "20 hafta", "18 ünite", "164 ders"]
] as const;
...
export default function HomePage() {
  return (
    <>
        ...
        <div className="container hero-grid">
          ...
          <div className="dashboard-mockup" aria-label="Deutschimo kullanıcı paneli ön izlemesi">
            ...
            <div className="mock-grid">
              ...
              <div className="mock-card"><span className="eyebrow">DEVAM EDİLEN KURS</span><h3>A1.1 Almancaya İlk Adım</h3><Progress value={42} label="%42 tamamlandı" /></div>
              <div className="mock-card"><span className="eyebrow">BUGÜNKÜ HEDEF</span><div className="metric">12/30</div><p>dakika tamamlandı</p><Button href="/learn/kendini-tanitmak">Derse Devam Et</Button></div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="section"><div className="container"><span className="eyebrow">NASIL ÇALIŞIR?</span><h2 className="section-title">Dört adımda ölçülebilir ilerleme</h2><div className="steps"><div className="step"><h3>Seviyeni belirle</h3><p>Kısa onboarding veya seviye testiyle başlangıç noktanı bul.</p></div><div className="step"><h3>Programını seç</h3><p>Hedefine ve çalışma sürene uygun öğrenme rotasını başlat.</p></div><div className="step"><h3>Günlük dersleri tamamla</h3><p>Video, okuma, quiz, kelime ve yazma görevleriyle çalış.</p></div><div className="step"><h3>İlerlemeni ölç</h3><p>Beceri raporlarını incele, eksik konulara geri dön ve sertifika kazan.</p></div></div></div></section>
