    ...
    <main className="container program-page">
      ...
      <div className="program-layout">
        ...
        <aside className="program-side">
          <section className="panel"><BookOpenCheck size={23}/><h3>Kurs kazanımları</h3><p>Bu alan, içerik editörü tarafından seviyeye özgü kazanımlarla doldurulacaktır.</p></section>
