...
const weights = { lessons: 40, exercises: 40, quiz: 20 };
const rules = { requireAllSlides: true, requireAllExercises: true, requireUnitQuiz: true, minimumQuizScore: 70, requireWritingAssignment: false, requireTeacherApproval: false };
const titles = {
    "A1": [
...
export const units = Object.entries(titles).flatMap(([level, levelTitles]) => levelTitles.map((title, index) => {
    const order = index + 1;
...
export const unitCounts = { A1: 12, A2: 16, B1: 18, B2: 20 };
