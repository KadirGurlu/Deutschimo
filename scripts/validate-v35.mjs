...
const [v35Major] = String(pkg.version ?? "").split(".").map(Number); if (!Number.isFinite(v35Major) || v35Major < 35) errors.push(`V35 icin surum en az 35.x olmali: ${pkg.version}`);
